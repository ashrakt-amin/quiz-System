...
<aside class="app-sidebar sidebar-scroll">
	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href=""><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon" viewBox="0 0 24 24">
						<g>
							<rect fill="none" />
						</g>
						<g>
					...
					<span class="side-menu__label">Teacher</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{route('quiz.index')}}">quiz list</a></li>
				</ul>
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href=""><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon" viewBox="0 0 24 24">
					...
					<span class="side-menu__label">Student</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{route('users.index')}}">Students</a></li>
					<li><a class="slide-item" href="{{route('quiz.index')}}">quiz list</a></li>
					<li><a class="slide-item" href="{{route('results')}}">Result</a></li>
				</ul>
			</li>
